<?php
	...
	if($sum==0)
	{
		echo "<script>alert(\"Cart Cannot be Empty\");";
    ...
    <body>
           ...
           <div class="container">
                <table class="table table-bordered table-striped">
                    <tbody>
                       ...
                       <?php $counter=$counter+1;}?>
                        <tr>
                    	<th></th><th>Total</th><th>Rs <?php echo $sum;?>/-</th><th><a href="checkout1.php?id=<?php echo $user_id?>&s=<?php echo $sum;?>" class="btn btn-primary">Confirm Order</a></th>
            ...
            <footer class="footer">
               <div class="container">
               <center>
                   <p>Copyright &copy Lifestyle Store. All Rights Reserved. | Contact Us: +91 9711083686</p>
                   <p>This website is developed by Harshit Bhatia</p>
               </center>
               </div>
           </footer>
        </div>
